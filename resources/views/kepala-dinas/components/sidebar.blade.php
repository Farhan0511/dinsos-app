         ...
         <div class="sidebar-content">
             <ul class="nav nav-secondary">
                 ...
                 <li class="nav-item {{ request()->routeIs('kepala-dinas.penerima') ? 'active' : '' }}">
                     <a href="{{ route('kepala-dinas.penerima.index') }}">
                 ...
                 <li class="nav-item {{ request()->routeIs('kepala-dinas.pendaftar') ? 'active' : '' }}">
                     <a href="{{ route('kepala-dinas.pendaftar.index') }}">
                         <i class="fas fa-table"></i>
                         <p>Data Pendaftar</p>
                     </a>
                 </li>

                 <li class="nav-item {{ request()->routeIs('kepala-dinas.laporan.index') ? 'active' : '' }}">
                     <a href="{{ route('kepala-dinas.laporan.index') }}">
