...
@section('content')
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
               <form action="{{ route('admin.verifikasi.update', $verifikasi->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select id="status" name="status" class="form-control">
                            <option value="belum diterima" {{ $verifikasi->status == 'belum diterima' ? 'selected' : '' }}>Belum Diterima</option>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date" id="tanggal_pengambilan" name="tanggal_pengambilan" class="form-control" required value="{{ old('tanggal_pengambilan', $verifikasi->tanggal_pengambilan) }}">
                    </div>

                    {{-- Tombol Aksi --}}
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">Submit</button>
                        <a href="{{ route('admin.verifikasi.index') }}" class="btn btn-danger">Batal</a>
                    </div>
                </form>
            </div>
        </div>
